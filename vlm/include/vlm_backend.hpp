...
class Backend {
    public:
        ...
        virtual void displace_wing(const TensorView<f32, 3, Location::Device>& transforms, MultiTensorView3D<Location::Device>&  verts_wing, MultiTensorView3D<Location::Device>& verts_wing_init) = 0;
