...
class Backend {
    public:
        ...
        f32 coeff_steady_cl_multi(const View<f32, MultiSurface>& verts_wing, const MultiTensorView2D<Location::Device>& gamma_delta, const FlowData& flow, const View<f32, MultiSurface>& areas);
        ...
        f32 coeff_steady_cd_multi(const View<f32, MultiSurface>& verts_wake, const MultiTensorView2D<Location::Device>& gamma_wake, const FlowData& flow, const View<f32, MultiSurface>& areas);
